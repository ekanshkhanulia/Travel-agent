...
def search_shops(city: str, categories: str, radius: int = 5000, limit: int = 5, **kwargs) -> Optional[Dict[str, Any]]:
    """
    ...
    """
    print(f"Starting shop search for '{categories}' in '{city}'...")
    try:
        ...
        #print(f"✅ Found shop: {result_data['name']}")
